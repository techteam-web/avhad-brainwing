...
// closing the page along the foot. The brand's skyline frames the pair from both edges.
export function Landing() {
  ...
  useGSAP(
    () => {
      gsap
        ...
        .fromTo('.js-sky-l', { opacity: 0, x: -60 }, { opacity: 1, x: 0, duration: 1.7, clearProps: 'opacity,transform' })
        .fromTo('.js-sky-r', { opacity: 0, x: 60 }, { opacity: 0.35, x: 0, duration: 1.7, clearProps: 'transform' }, 0)
  ...
  const enter = (slug, i) => {
    ...
    gsap
      ...
      .to('.js-tag, .js-mast, .js-sky-l, .js-sky-r', { opacity: 0, duration: 0.45, ease: 'power2.in', stagger: 0.04 }, 0)
  ...
  return (
    <main ref={root} className="brand-field relative flex h-dvh w-full flex-col overflow-clip text-bone">
      ...
      {/* the brand's own skyline, standing in from both edges to frame the pair */}
      <img src={skyline} alt="" className="js-sky-l pointer-events-none absolute -left-[6%] bottom-0 z-0 h-[62vh] w-auto md:-left-[3%] md:h-[68vh] 3xl:h-[72vh]" />
      <img src={skyline} alt="" className="js-sky-r pointer-events-none absolute -right-[6%] bottom-0 z-0 h-[62vh] w-auto -scale-x-100 opacity-35 md:-right-[3%] md:h-[68vh] 3xl:h-[72vh]" />
